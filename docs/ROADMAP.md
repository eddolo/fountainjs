...
or equating Fountain's AST with CommonMark's: 445 matches are regression-locked,
199 cases are explicitly pending, and eight safe-URL/GFM/editor-model
