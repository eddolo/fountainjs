...
or equating Fountain's AST with CommonMark's: 439 matches are regression-locked,
205 cases are explicitly pending, and eight safe-URL/GFM/editor-model
