...
geometry under a 1,000-block/50 ms browser gate. Editable page-shell rendering,
broader adversarial/cross-engine PDF fidelity, and the remaining evidence are
still active. CSS page-shaped boxes or
