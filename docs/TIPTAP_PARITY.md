...
| DOC-14 | Page layout, margins, page breaks, headers, and footers | Partial | The isolated neutral foundation, DOM measurement/controller, read-only preview, and guarded editable surface now cover A4/Letter/custom geometry; legal fragment flow; portable breaks, footnotes, templates, and fields; real line/list/table and long-footnote measurement; exact source projection; bounded incremental reflow; canonical whole-block/paragraph/list/rowspan-safe table and measured footnote continuation; safe merged multi-row header copies; unique editable page-intent rails; responsive fallback; explicit oversized row/atomic/footnote-fragment overflow; retained selection, IME, history, review, comments, movement, custom NodeViews, and Yjs; and a sanitized host-owned print projection for custom placements. Chromium, Firefox, and WebKit verify physical A4/Letter sheet geometry, stable named-page assignment, headers/page numbers, page-local footnotes, forced print breaks, accessibility isolation, removal of transient editor state, and exact editable/print long-footnote clips without duplicate or dropped fragments; Chromium additionally verifies emitted PDF page count, MediaBoxes, and page-specific extracted content. The latest immutable public certification is the 371-test package suite and browser matrix through the host-owned print renderer in [CI run `33a9920`](https://github.com/eddolo/fountainjs/actions/runs/33955189993), plus the corresponding [Pages deployment](https://github.com/eddolo/fountainjs/actions/runs/33955189994). Long-footnote continuation passes locally across all three desktop engines and is the next immutable gate. Keep this row Partial until broader adversarial visual/content print fixtures pass immutable CI. See [PAGINATION.md](PAGINATION.md). |
