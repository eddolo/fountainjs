...
| UI-02 | Bubble and floating menus | Partial | Framework-neutral named controllers, semantic default/custom visibility, reusable selection geometry, collision-aware placement, accessible React renderers, and package-backed desktop/mobile demos are implemented. Require the complete release gate and all-engine CI before marking delivered. |
