      ...
      { "type": "text", "text": "and typed", "marks": [{ "type": "strong" }] }
          ...
          <section className="dev-section" id="surfaces">
            ...
            <div className="dev-two-column dev-two-column--cards">
              ...
              <div><h3>Angular or your framework</h3><p>Use the DOM API or Web Component today. A first-party Angular binding remains pending. Create one editor, subscribe on mount, dispatch commands from UI, and destroy owned views/editors on unmount.</p></div>
            </div>
