    ...
    "content": [
      ...
      { "type": "text", "text": "and typed", "marks": [{ "type": "strong" }] }
          ...
          <section className="dev-section" id="extensions">
            ...
            <p>Select a formula to edit its source directly. Display math accepts Enter for new lines and Ctrl+Enter or Command+Enter to finish; inline math uses Enter to finish and Shift+Enter for a new line. Undo restores live edits. Multiline source and unchanged accessibility descriptions survive inspection. These controls edit formulas; whole-paper TeX layout and bibliography reproduction remain under the <a href="https://github.com/eddolo/fountainjs/blob/master/docs/REFERENCE_DOCUMENT_AUDIT.md">real-document audit</a>.</p>
