...
Object.assign(globalThis, {
  fountainBrowserTest: {
    ...
    docxVisual: { render: renderDOCXVisualComparison, math: async () => (await import('./docx-math-audit')).mountDOCXMathAudit(), controls: async () => (await import('./docx-controls-audit')).mountDOCXControlsAudit() },
    startImageUpload,
    collaboration: {
      leftEditor,
      rightEditor,
