  ...
  return (
    <main className="demos-site">
      ...
      <section className="boundary-section" id="boundaries">
        <p><a href="./math-renderer.html">Math renderer lab →</a> — edit typeset formulas and inspect actual published-equation failures. This capability lab is separate from the ten environment demos.</p>
