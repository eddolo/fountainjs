  ...
  return (
    <main className="demos-site">
      ...
      <section className="boundary-section" id="boundaries">
        ...
        <p><a href="./math-references.html">Equation references lab →</a> — edit and reorder the original labelled equations with locally bundled MathJax, inspect missing/duplicate references, and compare author and reader views. Whole-paper layout and visual exports remain separate audit work.</p>
