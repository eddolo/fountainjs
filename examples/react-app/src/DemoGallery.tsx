  ...
  return (
    <main className="demos-site">
      ...
      <section className="boundary-section" id="boundaries">
        ...
        <p><a href="./math-references.html">Equation references lab →</a> — edit and reorder the original labelled equations with locally bundled MathJax, save/reopen JSON files, inspect missing/duplicate references, and follow links across paged snapshots. Compare author and reader views; whole-paper layout and PDF/DOCX exports remain separate audit work.</p>
